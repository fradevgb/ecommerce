...
export function HomeHeroCategories({ categories }: Props) {
  return (
    <Grid templateColumns={{ base: "1fr 1fr", md: "540px 255px 255px" }} templateRows={{ base: "130px 154px 130px", md: "200px 260px" }} gap={{ base: "0.5rem", md: "30px" }} templateAreas={{ base: `"cat1 cat1" "cat2 cat3" "cat4 cat4"`, md: `"cat1 cat2 cat3" "cat1 cat4 cat4"` }}>
